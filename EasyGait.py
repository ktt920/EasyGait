...
* 6/23/26 : Develop the structure of the code with the assistance of Gemini AI. Incorporating convertion ratio logic by getting pixel distance and user define real world distance. Takes three points to denote the coordinate and frame of hindpaw movements on each leg to output stride length and speed. Validated the output generated to be similar to the one generated by PrAnCER program. Sanity Check the output falls within expected ranges.
